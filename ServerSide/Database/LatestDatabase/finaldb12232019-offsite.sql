...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='to store info about extra_classes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_extra_schedule` VALUES (1,'ACCEPTED','EXTRA',1001,1001,1001,5,2,1,'chup kar',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=358 DEFAULT CHARSET=utf8 COMMENT='For current week''s schedule';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_week_schedule` VALUES (1,1,NULL),(2,2,NULL),(3,3,NULL),(4,4,NULL),(5,5,NULL),(6,6,NULL),(7,7,NULL),(8,8,NULL),(9,9,NULL),(10,10,NULL),(11,11,NULL),(12,12,NULL),(13,13,NULL),(14,14,NULL),(15,15,NULL),(16,16,NULL),(17,17,NULL),(18,18,NULL),(19,19,NULL),(20,20,NULL),(21,NULL,1);
...
--
-- Temporary view structure for view `view_extra_schedule_without_where`
--

DROP TABLE IF EXISTS `view_extra_schedule_without_where`;
/*!50001 DROP VIEW IF EXISTS `view_extra_schedule_without_where`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_extra_schedule_without_where` AS SELECT 
 1 AS `extra_schedule_id`,
 1 AS `room_id`,
 1 AS `course_id`,
 1 AS `slot`,
...
--
-- Final view structure for view `view_extra_schedule_without_where`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_extra_schedule_without_where` AS select `tbl_week_schedule`.`extra_schedule_id` AS `extra_schedule_id`,`tbl_extra_schedule`.`room_id` AS `room_id`,`tbl_extra_schedule`.`course_id` AS `course_id`,`tbl_extra_schedule`.`slot` AS `slot`,`tbl_extra_schedule`.`day_of_week` AS `day_of_week`,`tbl_extra_schedule`.`class_length` AS `class_length`,`tbl_extra_schedule`.`accept_status` AS `accept_status`,`tbl_courses`.`teacher_id` AS `teacher_id` from ((`tbl_week_schedule` left join `tbl_extra_schedule` on((`tbl_week_schedule`.`extra_schedule_id` = `tbl_extra_schedule`.`extra_schedule_id`))) left join `tbl_courses` on((`tbl_extra_schedule`.`course_id` = `tbl_courses`.`course_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-12-23 19:08:27
