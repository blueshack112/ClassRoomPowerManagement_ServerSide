...
CREATE TABLE `tbl_extra_schedule` (
  ...
  KEY `extra_teacher_fkey_idx` (`requestor`),
  ...
  CONSTRAINT `extra_teacher_fkey` FOREIGN KEY (`requestor`) REFERENCES `tbl_login_accounts` (`account_id`)
...
-- Dump completed on 2019-12-23  8:32:56
